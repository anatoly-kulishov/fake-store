...
import { IBreadcrumbPath } from '@/shared/models';
...
export const Breadcrumb: FC<IBreadcrumbProps> = ({ startPath, paths, endPath }) => {
  return (
        ...
        {paths?.map(path => (
          <li key={path.href}>
            <div className="flex items-center">
              ...
              <Link href={path.href}>
                <span className="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 cursor-pointer">
                  {path.title}
                </span>
              </Link>
            </div>
