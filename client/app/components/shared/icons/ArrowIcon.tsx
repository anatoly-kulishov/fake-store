...
const ArrowIcon: FC<IconComponent> = ({ size = DEFAULT_ICONS_SIZE, ...rest }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 6 10" fill="#3B434E" xmlns="http://www.w3.org/2000/svg" {...rest}>
